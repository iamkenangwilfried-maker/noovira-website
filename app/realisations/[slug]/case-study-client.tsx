 ...
 * §2 THE WEBSITE:   Left heading + "See It Live ↗" | scrolling video gallery + arrows
 * §3 THE PROCESS:   4 alternating text-left / video-right rows
...
/** Video card that plays on hover (used in §4 grid) */
function VideoCard({ project }: { project: Project }) {
  ...
  return (
    ...
    >
      ...
      {/* Fallback screenshot if video not loaded yet */}
      <img
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div style={{ borderTop: "1px solid rgba(247,244,239,0.12)", marginBottom: 0 }} />
        </div>
      </section>
      ...
      <section className="section-dark py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          {/* Three screenshot thumbnails below */}
          <div className="grid grid-cols-3 gap-4 mt-4">
            {[
              shot(project.url, 600, 400),
              shot(project.url, 600, 400),
              shot(project.url, 600, 400),
            ].map((src, i) => (
              <div
            ...
            {processRows.map((row, i) => (
              ...
              >
                ...
                <div className={i % 2 === 1 ? "lg:order-2" : ""}>
                  ...
                  <div className="mt-6 text-text-light font-heading font-black text-lg">
                    {row.label}
                  </div>
                </div>
                ...
                <div className={i % 2 === 1 ? "lg:order-1" : ""}>
                  ...
                  >
                    <img
                      src={shot(project.url, 900, 560)}
                      alt={`${project.title} — étape ${i + 1}`}
                      className="w-full h-full object-cover object-top"
                      loading="lazy"
                    />
                  </div>
