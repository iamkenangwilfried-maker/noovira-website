...
const plans = [
  {
    ...
    price: "$197",
    period: "/mo",
    desc: "Your professional roofing website, live in 2 weeks. No upfront cost. Just a monthly hosting fee.",
    cta: "Get My Free Website",
    ctaStyle: "bg-white border-2 border-navy text-navy hover:bg-navy hover:text-white",
    featured: false,
    features: [
      "Custom roofing website (2 semaines)",
  ...
  },
  {
    ...
    features: [
      ...
      "2 semaines review follow-up sequence",
