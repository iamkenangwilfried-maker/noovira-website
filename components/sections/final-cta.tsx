      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 border border-white/30 text-text-light px-8 py-4 rounded-full font-bold text-base hover:border-white hover:bg-white hover:text-dark transition-all"
          >
