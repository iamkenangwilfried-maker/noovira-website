        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <a
                href="#contact"
                className="inline-flex items-center gap-2 bg-beige text-white px-6 py-3.5 rounded-full font-bold text-sm hover:bg-white hover:text-dark transition-colors flex-shrink-0"
              >
