  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="flex-1 hidden lg:flex items-center justify-center gap-6 px-6"
        ...
        <button
          ...
          className="lg:hidden flex-shrink-0 flex items-center justify-center transition-colors"
          style={{
            width: `${NAV_H}px`,
            minWidth: `${NAV_H}px`,
            background: "#2A2A2A",
